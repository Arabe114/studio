...
export default function AuthScreen({ onAuthenticated }: { onAuthenticated: () => void }) {
  ...
  return (
    <div className="flex h-screen w-full items-center justify-center bg-transparent">
        <AnimatedBackground />
        <div className={cn(
            "z-10 w-full max-w-md rounded-xl bg-card/60 backdrop-blur-lg border border-border p-8 text-center space-y-6 transform transition-transform duration-500",
